...
flowchart TD
  subgraph main
    439986771[return]:::RETURN
    439986795[args]:::FUNC_PARAM
    439986820[x]:::VARIABLE
    439986834[5]:::LITERAL
    439986845[y]:::VARIABLE
    439986870[8]:::LITERAL
    ...
    subgraph methodA
      439986885[return]:::RETURN
      439986912[a]:::FUNC_PARAM
      439986925[b]:::FUNC_PARAM
      439986948[c]:::VARIABLE
      439986962[+]:::BIN_OP
      439986885[return]:::RETURN --> 439986845[y]:::VARIABLE
