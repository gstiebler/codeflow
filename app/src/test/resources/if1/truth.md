...
flowchart TD
  subgraph b0["main"]
    ...
    n4[a]:::VARIABLE --> n12[if]:::VARIABLE
    n5[b]:::VARIABLE --> n7[==]:::BIN_OP
    n5[b]:::VARIABLE --> n13[if]:::VARIABLE
    n6[7]:::LITERAL --> n7[==]:::BIN_OP
    n7[==]:::BIN_OP --> n12[if]:::VARIABLE
    n7[==]:::BIN_OP --> n13[if]:::VARIABLE
    n8[13]:::LITERAL --> n9[b]:::VARIABLE
    n9[b]:::VARIABLE --> n13[if]:::VARIABLE
    n10[17]:::LITERAL --> n11[a]:::VARIABLE
    n11[a]:::VARIABLE --> n12[if]:::VARIABLE
